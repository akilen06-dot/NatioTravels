  ...
  return (
    <div className="mx-auto max-w-lg px-5 py-8">
      <div className="flex items-center justify-between">
        ...
        <h1 className="text-[15px] font-semibold text-ink">{t('Edit profile')}</h1>
        <div className="w-8" />
      </div>
      ...
      <p className="mt-8 text-[13.5px] font-medium text-ink">{t('Bio')}</p>
      <textarea
        value={bio}
        onChange={(e) => setBio(e.target.value)}
        rows={4}
        maxLength={150}
        placeholder={t('Tell other travelers a bit about you')}
