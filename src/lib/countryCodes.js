// Comprehensive country reference data — UN member states plus a few widely
// recognized others (Kosovo, Vatican City, Taiwan). Sorted by name. This is
// the single source of truth for both the phone country-code picker and the
// nationality dropdowns (see mockData.js).
//
// Excludes countries currently at the U.S. State Department's Level 4 "Do
// Not Travel" advisory (the highest tier), per product policy to only
// represent destinations considered safe to travel. Checked August 2026;
// advisory levels change, so revisit this list periodically.
